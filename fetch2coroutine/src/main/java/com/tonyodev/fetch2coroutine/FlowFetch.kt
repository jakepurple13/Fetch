...
interface FlowFetch {
     ...
     * @return Instance
     * */
    fun addListener(listener: FetchListener): FlowFetch
     ...
     * @return Instance
     * */
    fun addListener(listener: FetchListener, notify: Boolean = DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED): FlowFetch
     ...
     * @return Instance
     * */
    fun addListener(listener: FetchListener, notify: Boolean = DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED, autoStart: Boolean): FlowFetch
     ...
     * @return Instance
     * */
    fun removeListener(listener: FetchListener): FlowFetch
     ...
     * @return Instance
     * */
    fun enableLogging(enabled: Boolean): FlowFetch
     ...
     * @return Instance
     * */
    fun setGlobalNetworkType(networkType: NetworkType): FlowFetch
     ...
     * @return Instance
     * */
    fun setDownloadConcurrentLimit(downloadConcurrentLimit: Int): FlowFetch
     ...
     * @return instance
     * */
    fun attachFetchObserversForDownload(downloadId: Int, vararg fetchObservers: FetchObserver<Download>): FlowFetch
     ...
     * @return instance
     * */
    fun removeFetchObserversForDownload(downloadId: Int, vararg fetchObservers: FetchObserver<Download>): FlowFetch
     ...
     * @return instance
     * */
    fun addActiveDownloadsObserver(includeAddedDownloads: Boolean = false, fetchObserver: FetchObserver<Boolean>): FlowFetch
     ...
     * @return instance
     * */
    fun removeActiveDownloadsObserver(fetchObserver: FetchObserver<Boolean>): FlowFetch
    ...
    companion object Impl {
        ...
        @Volatile
        private var defaultRxFetchInstance: FlowFetch? = null

        /**
         * Sets the default Configuration settings on the default Fetch instance.
         * @param fetchConfiguration custom Fetch Configuration
         * */
        fun setDefaultFlowInstanceConfiguration(fetchConfiguration: FetchConfiguration) {
            synchronized(lock) {
         ...
         * */
        fun getDefaultFlowFetchConfiguration(): FetchConfiguration? {
         ...
         * */
        fun getDefaultFlowInstance(): FlowFetch {
            return synchronized(lock) {
                ...
                if (defaultRxFetch == null || defaultRxFetch.isClosed) {
                    val newDefaultRxFetch = FlowFetchImpl.newInstance(FetchModulesBuilder.buildModulesFromPrefs(rxFetchConfiguration))
         ...
         * */
        fun getFlowInstance(fetchConfiguration: FetchConfiguration): FlowFetch {
            return FlowFetchImpl.newInstance(FetchModulesBuilder.buildModulesFromPrefs(fetchConfiguration))
        }
